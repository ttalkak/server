...
public enum ErrorCode {
    ...
    KAFKA_CHANGE_DATABASE_STATUS_PRODUCER_ERROR(HttpStatus.SERVICE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE.value(), "데이터베이스 상태 변경 카프카 메시지 발행 도중 오류가 발생했습니다."),

    KAFKA_CREATE_DATABASE_PRODUCER_ERROR(HttpStatus.SERVICE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE.value(), "데이터베이스 생성 카프카 메시지 발행 도중 오류가 발생했습니다."),

    KAFKA_CHANGE_DEPLOYMENT_STATUS_PRODUCER_ERROR(HttpStatus.SERVICE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE.value(), "배포 상태 변경 카프카 메시지 발행 도중 오류가 발생했습니다."),

    KAFKA_CREATE_INSTANCE_PRODUCER_ERROR(HttpStatus.SERVICE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE.value(), "배포 생성 카프카 메시지 발행 도중 오류가 발생했습니다."),

    KAFKA_REBUILD_INSTANCE_PRODUCER_ERROR(HttpStatus.SERVICE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE.value(), "배포 재생성 카프카 메시지 발행 도중 오류가 발생했습니다."),

    KAFKA_FAVICON_PRODUCER_ERROR(HttpStatus.SERVICE_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE.value(), "파비콘 관련 카프카 메시지 발행 도중 오류가 발생했습니다."),
